...
export default function CurrencyDropdown(props) {
  ...
  return (
    <div className={`country-currency-container ${props.class}`}>
      <div className="country-currency-content">
        ...
        <div className="currency-flag" onClick={props.toggleFlagMenu}>
          ...
          {countryData?  
            <div className='currency-flag-menu' style={{height: menuOpen ? "180px" : "60px"}}>
              {countryData.map((country) => {
                  return (
                      <div className="flag-menu-info" key={country.id} onClick={() =>(openMenu(country.id))} >
